...
export default function BatchDashboard({ params }: PageProps) {
  ...
  // Profile Sync States (To match Homepage LocalStorage)
      ...
      <main style={contentArea}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={batchBanner}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <h2 style={{ fontSize: '42px', fontWeight: '900', margin: '10px 0' }}>{batchId.toUpperCase()} MISSION...</h2>
          </div>
        </motion.div>
        ...
        <div style={dashboardGrid}>
          <div style={{ flex: 1 }}>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom: '20px' }}>
              ...
              {isOwner && (
                <motion.button whileHover={{ scale: 1.05 }} onClick={() => {setEditingEvent(null); setShowEventModal(true)}} style={addBtn}>+ Create</motion.button>
              )}
            </div>
            {events.map(ev => (
...
const headerInner: any = { maxWidth:'1280px', margin:'0 auto', display:'flex', justifyContent:'space-between', alignItems:'center', height:'100%', padding:'0 25px' };
...
const contentArea: any = { paddingTop:'115px', maxWidth:'1200px', margin:'0 auto', padding:'0 25px 50px' };
const batchBanner: any = { background:'#1c252e', color:'#fff', padding:'70px 50px', borderRadius:'0 0 70px 0', marginBottom:'40px', position: 'relative', overflow: 'hidden' };
...
const streakCard: any = { width:'380px', background:'#fff', borderRadius:'30px', overflow:'hidden', position:'relative', textAlign:'center' };
...
const iconCircleUI: any = { position: 'relative', width: '52px', height: '52px', borderRadius: '16px', background: '#fff', display: 'flex', alignItems: 'center', justifyContent:'center', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' };
const redDotNotif: any = { position: 'absolute', top: '0', right: '0', width: '10px', height: '10px', background: '#ef4444', borderRadius: '50%', border: '2px solid #fff' };
...
const notifSendBtn: any = { flex: 1, padding: '12px', background: '#111', color: '#fff', border: 'none', borderRadius: '12px', fontWeight: 'bold', marginTop: '10px', cursor:'pointer' };

const addBtn: any = { background:'#6157ff', color:'#fff', border:'none', padding:'12px 25px', borderRadius:'16px', fontWeight:'bold', cursor:'pointer' };
